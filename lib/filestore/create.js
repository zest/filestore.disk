...
module.exports = function (config) {
    var logger = config.logger.group('create'),
        /**
        ...
        create = function (relativePath, fileData) {
            ...
            if (fileData instanceof stream.Readable) {
                ...
                logger.debug('creating file from stream:', relativePath);
                return create(
            ...
            logger.debug('creating file from data:', relativePath);
            return q.denodeify(fs.outputFile)(
                ...
                function () {
                    ...
                    process.nextTick(function () {
                        logger.debug('emitting create event for', relativePath);
