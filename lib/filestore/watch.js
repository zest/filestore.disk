'use strict';
/**
 * @fileOverview The filestore-disk/watch module returns the {@link module:filestore-disk/watch~Watch|watch}
 * function.
 ...
 * @returns {module:filestore-disk/watch~Watch} the watch function
 */
module.exports = function (config) {
     ...
     * @param {String} [eventType] - eventType, if specified, can be <b>create</b> or <b>remove</b> which will
     * restrict watching only file creations or deletions respectively. If not specified, both creation and deletion
     * will be watched.
     * @param {module:filestore-disk/watch~Callback} callback - the callback function to be called when a watched file
     * is changed, created or removed
     * @callback module:filestore-disk/watch~Watch
     * @see module:filestore-disk/unwatch~Unwatch
     */
 ...
 * @param {String} event - the event that triggered the watcher function. Can be <b>create</b> or <b>remove</b>.
