...
describe(
    'filestore.disk#create', function () {
        before(
            function (done) {
        ...
        it(
            'should be able to create and read an empty folder', function () {
                return disk.create('folder-one').then(
                    function () {
        ...
        it(
            'should be able to create and read a folder with contents', function () {
